...
class Product(Base):
    ...
    seller_sku = Column(String(128), nullable=True)
    wb_sku = Column(String(128), nullable=True)
    nm_id = Column(Integer, nullable=True, unique=True, index=True)
    title = Column(String(512), nullable=False)
    brand = Column(String(255), nullable=True, index=True)
    category = Column(String(255), nullable=True)
    price_src = Column(Float, nullable=True)
    seller_discount_pct = Column(Float, nullable=True)
    price = Column(Float, nullable=True)
    product_cost = Column(Float, nullable=True)
    shipping_cost = Column(Float, nullable=True)
    logistics_back_cost = Column(Float, nullable=True)
    warehouse_coeff = Column(Float, nullable=True)
    weight_kg = Column(Float, nullable=True)
    package_l_cm = Column(Float, nullable=True)
    package_w_cm = Column(Float, nullable=True)
    package_h_cm = Column(Float, nullable=True)
    volume_l = Column(Float, nullable=True)
    stock = Column(Integer, nullable=True)
    stock_wb = Column(Integer, nullable=True)
    stock_seller = Column(Integer, nullable=True)
